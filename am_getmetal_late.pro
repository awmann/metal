...
;
; Giving Credit:
;        If you make use of this code please cite Mann et al. (ApJ, in
;        review).
...
;                the error spectrum)
;       error    Error spectrum in erg/s/cm^2/A (the absolute units
;                are unimportant)
;
; OUTPUT PARAMETERS: 
;       feh      [Fe/H]
...
;       resolution (among other things). This is easier to handle at
;       higher resolution, since you can always degrade the spectrum,
;       but then again high-resolution spectra might result in
;       incorrect estimation of the H2O index.
;       I suggest collecting spectra of >=10 stars from the binary
;       sample to correct for systematic offsets between the instruments. 
